                  ...
                  >
                    <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
                      <div className="flex-1 lg:pr-12">
                        ...
                        <h3 className="font-FoundersGroteskXCond-Bold text-2xl lg:text-3xl mb-4 group-hover:text-[#cdea68] transition-colors duration-300">
                          {event.title}
                        </h3>
                      ...
                      <div className="mt-6 lg:mt-0">
                        <button className="bg-[#cdea68] text-zinc-900 px-6 py-3 rounded-full font-NeueMontreal-Regular hover:bg-[#b8d654] transition-colors duration-300">
                          Register
                        </button>
                      </div>
                    </div>
