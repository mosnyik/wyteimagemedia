    ...
    >
          ...
          >
            {index == 1 && (
              <motion.div
                ...
                animate={{ width: "9vw" }}
                transition={{ ease: [0.76, 0, 0.24, 1], duration: "1" }}
                className=" bg-green-400 overflow-hidden rounded-md h-[2.4rem] w-16 md:h-[2.9rem] md:w-20 lg:h-[5.1rem] lg:w-32 mr-2 md:mr-3 lg:mr-5 flex items-center justify-center"
              >
                <span className="text-zinc-900 font-bold text-xs md:text-sm lg:text-lg">
                  WIM
                </span>
              </motion.div>
            )}
      ...
      <div className="heading relative pt-44 pb-48 font-FoundersGroteskXCond-Bold text-6xl md:text-7xl lg:text-9xl uppercase flex items-start">
        ...
        <motion.div
          ...
          animate={{ width: "9vw" }}
          transition={{ ease: [0.76, 0, 0.24, 1], duration: 1 }}
          className="bg-green-400 overflow-hidden rounded-md 
               h-[2.4rem] w-16 md:h-[2.9rem] md:w-20 
               lg:h-[5.1rem] lg:w-32 mr-4 
