            ...
            <div className="space-y-8">
              <div className="space-y-4">
                <h1 className="text-4xl md:text-6xl font-bold leading-tight">
                  Creating
                  <span className="text-primary block animate-pulse-glow">Unforgettable</span>
                  Experiences
                </h1>
                <p className="text-xl text-muted-foreground leading-relaxed">
                  From award ceremonies to magazine publications, we bring your vision to life with creativity,
                  precision, and international excellence.
                </p>
              </div>
